...
export default function UserMetaCard() {
  ...
  const handleSave = async () => {
    ...
    const updatedUser: LoginUser = {
      userId: user?.userId,
      avatar: user.avatar,
      nickName: nickNameRef.current?.value || user.nickName,
            ...
            <div className="order-3 xl:order-2">
              ...
              <div className="flex flex-col items-center gap-1 text-center xl:flex-row xl:gap-3 xl:text-left">
                <p className="text-sm text-gray-500 dark:text-gray-400">
                  {Number(user?.gender) === 1 ? "Male" : "Female"}
                </p>
              </div>
            </div>
            {/** Social Media button, can be used after add user attributes */}
              ...
              <div className="mt-7">
                ...
                <div className="grid grid-cols-1 gap-x-6 gap-y-5 lg:grid-cols-2">
                  <div className="col-span-2 lg:col-span-1">
                    ...
                    <Input type="text" ref={nickNameRef} defaultValue={user?.nickName} />
                  </div>
                  ...
                  <div className="col-span-2 lg:col-span-1">
                    <Label>Phone</Label>
                    <Input type="text" ref={phoneRef} defaultValue={user?.phone} />
                  </div>
                  ...
                  <div className="col-span-2">
                    ...
                    <select
                        ...
                        id="gender"
                        name="gender"
                        defaultValue={String(user?.gender)} // 保持选中状态
